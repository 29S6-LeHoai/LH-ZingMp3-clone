import { MdOutlineLibraryMusic, MdOutlineClear, MdLogout, MdOutlineMoreHoriz } from 'react-icons/md';
...
import { IoSettingsOutline, IoPlay } from 'react-icons/io5';
import {
    AiOutlineHeart,
    AiFillHeart,
    AiOutlinePlayCircle,
...
export const LoadingIcon = ({ notLoading }) => {
    return (
        <>
            <i className={`icon   ${notLoading ? 'load' : 'loading'}`}>
                <svg className="lds-spinner" width="34px" height="34px" viewBox="0 0 100 100">
...
export const KhamphaIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const ZingchartIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const RadioIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const FollowIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const NewmusicIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const TheloaIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const Top100Icon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const MVIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const ThemeIcon = ({ height = '2rem', width = '2rem', className }) => {
    return (
